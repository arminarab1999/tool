...
██████       ██████       ██████     ██   ██        ██           ██        ██          ███████ 
    ...
    print(f"""
    {green}―――――――――――――――――――――――――――――――――――――――――――――――――――――――
    {red}|1| {green}Port-Scanner                 {red}|7| {green}SMS-Bomber2      
    {red}|2| {green}Admin-Finder                 {red}|8| {green}DoxTracker
    {red}|3| {green}Ghost_Tracker                {red}|9| {green}none
    {red}|4| {green}DDOS                         {red}|10| {green}none
    {red}|5| {green}Admin-finder2                {red}|11| {green}none
    {red}|6| {green}SMS-Bomber                   {red}|12| {green}none 
    {green}――――――――――――――――――――――――――――――――――――――――――――――――――――――――
    """)
