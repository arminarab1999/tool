...
\033[1;31m  88\033[1;33m8P' `Y8P'\033[1;32m dP Yb   8\033[1;36m   8    `Y88 `Y8\033[1;34mP 8 Yb `Y88P 8
     ...
     \033[1;31mPeOpLe TrAcKeR\033[1;m \033[1;34mBY\033[1;m DOCKTYPE \033[1;33mVersion:\033[1;32m Beta 1.0\033[1;35m
     """)
...
\033[1;36m       99. About
	...
	if OPT == "1":
		...
		KURO()
		webbrowser.open('https://github.com/arminarab1999?tab=repositories')
		menu()
	else:
		KURO()
		LOGO()
